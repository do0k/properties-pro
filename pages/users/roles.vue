  ...
  el-page-header.p-3(icon="" element-loading-text="درحال بارگزاری ...")
    ...
    el-skeleton(:loading="pending" animated)
      ...
      el-table(
        ...
        el-table-column(width="100" label="نام و نام خانوادگی")
        ...
        el-table-column(fixed="right" align="right")
          ...
          template(#default="{ row }")
            //- el-button-group.mx-3
            //-   el-tooltip(effect="dark" placement="top" content="تایید")
            //-     el-button(
            //-       v-show="canConfirm(row)"
            //-       type="success"
            //-       :icon="Check"
            //-       size="small"
            //-       text
            //-       class="!px-2",
            //-       @click="confirm('confirmed', row.id)")
            //-   el-tooltip(effect="dark" placement="top" content="عودت")
            //-     el-button(
            //-       v-show="canReject(row)"
            //-       type="danger"
            //-       :icon="X"
            //-       size="small"
            //-       text
            //-       class="!px-2",
            //-       @click="confirm('denied', row.id)")
            //- el-tooltip(v-if="isRejected(row)" effect="dark" placement="right" content="درخواست تایید ارفاقی")
            //-   el-button.ml-2(
            //-       :type="hasException(row, 'commerce') ? 'info' : 'warning'"
            //-       text
            //-       class="!px-2",
            //-       size="small"
            //-       :disabled="hasException(row, 'commerce')"
            //-       @click="openReq(row.id)")
            //-     template(#icon)
            //-       icon(name="teenyicons:contract-outline")
            //- el-tooltip(effect="dark" placement="right" content="تصحیح فروشنده")
            //-   el-button(
            //-     v-show="canConfirm(row)"
            //-     type="primary"
            //-     size="small"
